				...
				@foreach($usuarios as $usuario)
					<tr>
						...
						<td>
							...
							<a href="javascript: if(confirm('Tem certeza que deseja deletar esse usuário?')){ window.location.href = '{{route('admin.usuarios.deletar', $usuario->id) }}' }" class="btn red">Deletar</a>
						</td>
					</tr>
				@endforeach
				</tbody>
